...
contract ClockAuction is Pausable, Ownable, ClockAuctionBase {
    ...
    constructor(address _nftAddress, uint256 _cut) {
        require(
            _cut <= 10000,
            "_cut should vve smaller than or equal to 10000"
        );
        ownerCut = _cut;
        ...
        require(
            ...
            "this contract doesn't support ERC721 standard"
        );
    ...
    function withdrawBalance() external {
        ...
        // nftAddress.transfer(this.balace);
    ...
    function cancelAuction(uint256 _tokenId) public {
        ...
        require(_isOnAuction(auction), "this _tokenId in not on the auction");
