...
contract ClockAuctionBase is ERC721Holder {
    ...
    modifier canBeStoredWith64Bits(uint256 _value) {
        require(_value <= 18446744073709551615, "_value exceeds 64bits limit");
        _;
    }
    ...
    function _addAuction(uint256 _tokenId, Auction memory _auction) internal {
        ...
        require(
            ...
            "Auction duration should be greater than or equal to 1 minutes"
        );
    ...
    function _bid(
        ...
        require(_isOnAuction(auction), "this token is not on the auction");
        ...
        require(
            _bidAmount >= price,
            "_bidAmount shoud be greater than or equal to auction's current price"
        );
